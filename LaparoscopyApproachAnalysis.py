...
class LaparoscopyApproachAnalysis:
  def __init__(self, parent):
    parent.title = "LaparoscopyApproachAnalysis" # TODO make this more human readable by adding spaces
    ...
    try:
      ...
      slicer.selfTests = {}
    slicer.selfTests['LaparoscopyApproachAnalysis'] = self.runTest

  def runTest(self):
    tester = LaparoscopyApproachAnalysisTest()
    tester.runTest()

#
# qLaparoscopyApproachAnalysisWidget
#

class LaparoscopyApproachAnalysisWidget:
  ...
  def setup(self):
    ...
    self.reloadButton.name = "LaparoscopyApproachAnalysis Reload"
  ...
  def onReload(self,moduleName="LaparoscopyApproachAnalysis"):
  ...
  def onReloadAndTest(self,moduleName="LaparoscopyApproachAnalysis"):
    try:
      self.onReload()
...
#
# LaparoscopyApproachAnalysisLogic
#

class LaparoscopyApproachAnalysisLogic:
...
class LaparoscopyApproachAnalysisTest(unittest.TestCase):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_LaparoscopyApproachAnalysis1()

  def test_LaparoscopyApproachAnalysis1(self):
